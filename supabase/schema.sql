...
-- ALTER ROLE "authenticator" WITH NOINHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:1iByQTV9/zK3Mq2RjETWbQ==$GHEcSGizQ7ciA+00U6eKv8rJkvNCeikjjOxacft2lBg=:uImz9bTa8YHCNIBlpt5eBL3h5m/rzXpk/9/wJYMtvWE=';
-- CREATE ROLE "dashboard_user";
-- ALTER ROLE "dashboard_user" WITH INHERIT CREATEROLE CREATEDB NOLOGIN REPLICATION NOBYPASSRLS;
-- CREATE ROLE "pgbouncer";
-- ALTER ROLE "pgbouncer" WITH INHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:KrjlcjCVOrrfabSxfSjcnw==$ANj7mKIAjBtTRTP5mcADg7hGEt8H696DN951hhzJ4t0=:SeuOaB5NMHQbqYWytiRdzY5O0kPmBMqqwoTNMJHcARQ=';
-- CREATE ROLE "postgres";
-- ALTER ROLE "postgres" WITH INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:4k5mXyBRO5FxHDBehOVrcg==$pMDpaUlH5zFjkgXVXBYkNSug9hOT56TrUPIjRH0VVYo=:BnTo610JKsQpqylijloN23ZkClt+pKBiODCZqTorSYc=';
-- CREATE ROLE "service_role";
-- ALTER ROLE "service_role" WITH INHERIT NOCREATEROLE NOCREATEDB NOLOGIN BYPASSRLS;
-- CREATE ROLE "supabase_admin";
-- ALTER ROLE "supabase_admin" WITH SUPERUSER INHERIT CREATEROLE CREATEDB LOGIN REPLICATION BYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:6SwQbqYdMoJsP0gRtqYHBw==$RJfx1PbbgUm9ZYZf1fJ2s5WOIXniVKodeJV2jlyA2mk=:WsVC+NNXr0hkC3TdRCEV/mBa64V/9ZqTLvI0hhOXx5g=';
-- CREATE ROLE "supabase_auth_admin";
-- ALTER ROLE "supabase_auth_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:352DKWp9cC5RVL7d4g1a/g==$9SttJWgG+j+2BlZF9rWgo+KzkgzBKlVeamDv0dK6InQ=:GQD3uxw1823cP3HP7n+AmLrwwlrlZV3x4Il4n3D1Pk0=';
-- CREATE ROLE "supabase_functions_admin";
-- ALTER ROLE "supabase_functions_admin" WITH SUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:rdVy6qkDCS2oZASKsndLog==$QuOxr9lQbM/KSplDASA33BpSZkNquJJmrMqiewOwpsQ=:j7emRnO0nSZEcXC5Ux4l0NIuZWiJZE9Z/Fmr2Yfi6Qw=';
...
-- ALTER ROLE "supabase_storage_admin" WITH NOINHERIT CREATEROLE NOCREATEDB LOGIN NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:y1BKy4Dnossri4dBB0mzSg==$sjcBsZfHjTkeZKOQr+D/bujexNqpvP63TRVsZsvQ/9g=:prz7UrBJvuMuknlC8roIlgSH99y9IiZW0QZWaDeyJMU=';
...
CREATE TABLE "public"."devices" (
    ...
    "device_name" "text" DEFAULT '我的营养秤'::"text" NOT NULL,
    "device_model" "text",
    "service_uuid" "text",
...
CREATE TABLE "public"."family_members" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "user_id" "uuid" NOT NULL,
    "nickname" "text" DEFAULT '主用户'::"text" NOT NULL,
    "avatar_url" "text",
...
CREATE TABLE "public"."reminder_settings" (
    ...
    "breakfast_time" "text" DEFAULT '07:30'::"text",
    "lunch_enabled" boolean DEFAULT false,
    "lunch_time" "text" DEFAULT '12:00'::"text",
    "dinner_enabled" boolean DEFAULT false,
    "dinner_time" "text" DEFAULT '18:30'::"text",
    "water_enabled" boolean DEFAULT false,
    "water_time" "text" DEFAULT '09:00'::"text",
    "updated_at" timestamp with time zone DEFAULT "now"()
);


--
-- Name: user_active_member; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: reminder_settings reminder_settings_user_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: user_active_member user_active_member_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."user_active_member"
    ADD CONSTRAINT "user_active_member_pkey" PRIMARY KEY ("user_id");
...
--
-- Name: chat_sessions chat_sessions_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "chat_sessions_updated_at" BEFORE UPDATE ON "public"."chat_sessions" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at"();
...
--
-- Name: family_members family_members_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER "family_members_updated_at" BEFORE UPDATE ON "public"."family_members" FOR EACH ROW EXECUTE FUNCTION "public"."update_updated_at"();
...
--
-- Name: chat_sessions chat_sessions_member_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."chat_sessions"
    ADD CONSTRAINT "chat_sessions_member_id_fkey" FOREIGN KEY ("member_id") REFERENCES "public"."family_members"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."reminder_settings"
    ADD CONSTRAINT "reminder_settings_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;


--
-- Name: user_active_member user_active_member_member_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."user_active_member"
    ADD CONSTRAINT "user_active_member_member_id_fkey" FOREIGN KEY ("member_id") REFERENCES "public"."family_members"("id") ON DELETE CASCADE;


--
-- Name: user_active_member user_active_member_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."user_active_member"
    ADD CONSTRAINT "user_active_member_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;


--
-- Name: weighing_records weighing_records_member_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY "public"."weighing_records"
    ADD CONSTRAINT "weighing_records_member_id_fkey" FOREIGN KEY ("member_id") REFERENCES "public"."family_members"("id") ON DELETE SET NULL;
...
ALTER TABLE ONLY "public"."weighing_records"
    ADD CONSTRAINT "weighing_records_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "public"."profiles"("id") ON DELETE CASCADE;
...
--
-- Name: user_active_member; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: chat_messages 用户可删除自己会话的消息; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "用户可删除自己会话的消息" ON "public"."chat_messages" FOR DELETE TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."chat_sessions"
  WHERE (("chat_sessions"."id" = "chat_messages"."session_id") AND ("chat_sessions"."user_id" = "auth"."uid"())))));


--
-- Name: chat_messages 用户可插入自己会话的消息; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "用户可插入自己会话的消息" ON "public"."chat_messages" FOR INSERT TO "authenticated" WITH CHECK ((EXISTS ( SELECT 1
   FROM "public"."chat_sessions"
  WHERE (("chat_sessions"."id" = "chat_messages"."session_id") AND ("chat_sessions"."user_id" = "auth"."uid"())))));


--
-- Name: family_members 用户可操作自己的家庭成员; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "用户可操作自己的家庭成员" ON "public"."family_members" TO "authenticated" USING (("user_id" = "auth"."uid"()));


--
-- Name: chat_sessions 用户可操作自己的对话会话; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "用户可操作自己的对话会话" ON "public"."chat_sessions" TO "authenticated" USING (("user_id" = "auth"."uid"()));


--
-- Name: reminder_settings 用户可操作自己的提醒设置; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "用户可操作自己的提醒设置" ON "public"."reminder_settings" TO "authenticated" USING (("user_id" = "auth"."uid"()));


--
-- Name: user_active_member 用户可操作自己的激活成员; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "用户可操作自己的激活成员" ON "public"."user_active_member" TO "authenticated" USING (("user_id" = "auth"."uid"()));


--
-- Name: weighing_records 用户可操作自己的称重记录; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "用户可操作自己的称重记录" ON "public"."weighing_records" TO "authenticated" USING (("user_id" = "auth"."uid"()));


--
-- Name: devices 用户可操作自己的设备; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "用户可操作自己的设备" ON "public"."devices" TO "authenticated" USING (("user_id" = "auth"."uid"()));


--
-- Name: profiles 用户可更新自己的资料; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "用户可更新自己的资料" ON "public"."profiles" FOR UPDATE TO "authenticated" USING (("auth"."uid"() = "id")) WITH CHECK ((NOT ("role" IS DISTINCT FROM "public"."get_user_role"("auth"."uid"()))));


--
-- Name: chat_messages 用户可查看自己会话的消息; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "用户可查看自己会话的消息" ON "public"."chat_messages" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."chat_sessions"
  WHERE (("chat_sessions"."id" = "chat_messages"."session_id") AND ("chat_sessions"."user_id" = "auth"."uid"())))));


--
-- Name: profiles 用户可查看自己的资料; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: profiles 管理员有完整权限; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "管理员有完整权限" ON "public"."profiles" TO "authenticated" USING (("public"."get_user_role"("auth"."uid"()) = 'admin'::"public"."user_role"));
...
--
-- Name: objects chat_images_anon_insert; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "chat_images_anon_insert" ON "storage"."objects" FOR INSERT TO "anon" WITH CHECK (("bucket_id" = 'chat-images'::"text"));


--
-- Name: objects chat_images_delete; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "chat_images_delete" ON "storage"."objects" FOR DELETE TO "authenticated" USING ((("bucket_id" = 'chat-images'::"text") AND (("storage"."foldername"("name"))[1] = ("auth"."uid"())::"text")));


--
-- Name: objects chat_images_insert; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "chat_images_insert" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK ((("bucket_id" = 'chat-images'::"text") AND (("storage"."foldername"("name"))[1] = ("auth"."uid"())::"text")));


--
-- Name: objects chat_images_select; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "chat_images_select" ON "storage"."objects" FOR SELECT USING (("bucket_id" = 'chat-images'::"text"));


--
-- Name: objects generated_audio_public_read; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "generated_audio_public_read" ON "storage"."objects" FOR SELECT USING (("bucket_id" = 'generated-audio'::"text"));


--
-- Name: objects generated_audio_service_insert; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "generated_audio_service_insert" ON "storage"."objects" FOR INSERT WITH CHECK (("bucket_id" = 'generated-audio'::"text"));
...
--
-- Name: supabase_realtime weighing_records; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION "supabase_realtime" ADD TABLE ONLY "public"."weighing_records";
...
chat-images	chat-images	\N	2026-06-08 05:54:29.298153+00	2026-06-08 05:54:29.298153+00	t	f	5242880	{image/jpeg,image/png,image/webp,image/gif}	\N	STANDARD
generated-audio	generated-audio	\N	2026-06-08 13:34:34.92666+00	2026-06-08 13:34:34.92666+00	t	f	10485760	{audio/mpeg,audio/mp3,audio/wav,audio/ogg,application/octet-stream}	\N	STANDARD
\.
